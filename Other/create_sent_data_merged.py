...
for row in para_data.index:
    ...
    source = para_data["source"][row]
    category_int = para_data["category_int"][row]
    plant_group_int = para_data["plant_group_int"][row]
    source_int = para_data["source_int"][row]
    ...
    for sent in doc.sents:
        ...
        data_df["plant_group_int"].append(plant_group_int)
        data_df["source_int"].append(source_int)
...
sent_data.to_csv('merged_edited_data_sents.csv')
